...
class CSAccentButton extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => CSAccentButtonState();
}

class CSAccentButtonState extends State<CSAccentButton> {
    ...
    return AnimatedScale(
      ...
      child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            (widget.disabledBackgroundColor ?? Theme.of(context).colorScheme.primaryContainer)
      ...
      children: [
        ...
        Text(
          ...
          style: widget.textStyle ?? Theme.of(context).textTheme.labelLarge?.copyWith(
            color: widget.isDisabled ? Theme.of(context).textTheme.bodyMedium?.color?.withOpacity(0.5) : Colors.black,
          ),
        )
      ],
    );
