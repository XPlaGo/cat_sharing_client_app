...
class CSVerificationCode extends StatefulWidget {
  ...
  @override
  _CSVerificationCodeState createState() => _CSVerificationCodeState();
}

class _CSVerificationCodeState extends State<CSVerificationCode> {
  ...
  Widget _buildInputItem(int index) {
    final decoration = InputDecoration(
      ...
      contentPadding: widget.padding ?? const EdgeInsets.symmetric(vertical: 15, horizontal: 15),
      filled: true,
      counterText: "",
      fillColor: Theme
          .of(context)
